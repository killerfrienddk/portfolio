<template>
    <panel-component id="resume">
        ...
        <div class="flex md:flex-row flex-col space-y-8">
            <div class="md:w-3/5 w-full space-y-2 -mt-4">
            ...
            <div class="md:w-2/5 w-full">
                <timeline>
                    <timeline-point start-date="09-01-2026" :date-moment="true" title="Full Stack Developer" detail="Unit4 · Full-time · Remote"/>
...
function getYears() {
    let date = dayjs();
    return date.clone().diff('01-01-2019', 'years');
}
</script>
